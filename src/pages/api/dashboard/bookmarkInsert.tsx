...
const BookmarkInsert = async (req: any, res: any) => {
    try {
        ...
        const url = process.env.NEXT_PUBLIC_JCAJSPDOMAIN + "/mng/sctItm/ajax/usrSctItmInsert_ajax.jsp";
